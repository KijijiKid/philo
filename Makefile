...
CORE_FILES	:= $(addprefix $(CORE_DIR), $(addsuffix .c, type_converters error input_parsing thread_init thread_destroy struct_init time routine forks_init msg_monitor)) 
