...
/*   Updated: 2025/09/26 12:31:52 by mandre           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	create_threads(t_meta *philo_meta)
{
	...
	usleep(500); // I just do that to make sure that msg_thread is already up and going till philo logic runs -> TODO: find better way
	i = 0;
