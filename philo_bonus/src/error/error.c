...
/*   Updated: 2025/10/05 18:53:33 by mandre           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	throw_error(t_status status)
{
	...
	else if (status == SEM_CREATION)
		write_input(I_SEM_FAILED, NULL);
	else if (status == SEM_CLOSE_FAILED)
		write_input(D_SEM_FAILED, NULL);
